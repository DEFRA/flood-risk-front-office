...
ActiveRecord::Schema.define(version: 20_160_415_202_953) do
  ...
  add_index 'flood_risk_engine_enrollments_exemptions', %w(enrollment_id exemption_id), name: 'fre_enrollments_exemptions_enrollment_id_exemption_id', unique: true, using: :btree
  ...
  add_index 'flood_risk_engine_organisations', ['type'], name: 'index_flood_risk_engine_organisations_on_type', using: :btree
